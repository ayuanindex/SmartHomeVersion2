...
public class GroupListBean {
    ...
    /**
     * Response : {"GroupInfos":[{"GroupName":"腾讯深圳员工","GroupId":"TencentShenZhenEmployee","GroupExDescriptions":["事业群","部门名","组名"],"Tag":"不含实习生"},{"GroupName":"某某大学竹园宿舍楼1号楼","GroupId":"ZhuYuanDormitoryNo1","GroupExDescriptions":["学院名","专业","年级","学号"],"Tag":"全是女生哦"}],"Error":{"Code":"InvalidParameterValue.LimitExceed","Message":"返回数量不在合法范围内。"},"GroupNum":2,"RequestId":"72102087-a18d-4225-9ae9-87ef49e9f63e"}
     */
